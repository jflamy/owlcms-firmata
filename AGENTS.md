...
- Never perform blocking work on the Vaadin UI thread or inside `ui.access(...)`. Run network requests, device I/O, and other blocking work in a background worker.
